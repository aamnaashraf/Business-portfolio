              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    href="/services"
                    className="bg-purple-400 hover:bg-purple-500 text-white px-6 py-3 sm:px-8 sm:py-3 rounded-lg font-medium transition-all duration-300 flex items-center justify-center gap-2"
                  >
